...
// organic layout instead of a handful of symmetric lines. Routed on a
// finer grid than the first pass for roughly 3x the density.
const PCB_TRACES = [
  "M210 260 H250 V200 H340",
  "M530 400 V410 H290",
  "M360 300 H310 V240 H270 V220",
  "M270 300 V270 H290 V360",
  "M650 110 H720 V180 H750 V160 H790",
  "M640 330 H620 V240",
  "M300 0 H240 V40",
  "M10 230 H20 V310 H10",
  "M740 270 V260 H690 V280 H650 V300 H690 V320 H700 V350 H730",
  "M80 90 V40 H50",
  "M290 140 H270 V90 H290",
  "M50 270 V260 H70 V340 H0",
  "M520 390 H480 V340 H530 V380 H620",
  "M560 20 V50 H460 V10",
  "M420 340 H430 V330 H470",
  "M630 70 H690 V60 H740 V40 H700",
  "M470 10 H500 V30",
  "M190 50 V60 H160 V130 H130 V200 H120 V220 H130",
  "M150 10 H100 V0 H60",
  "M580 100 H570 V90 H560 V80 H500 V70",
  "M700 210 H640 V270",
  "M300 40 H310 V10 H350 V0",
  "M150 350 H80",
  "M600 350 H640 V390 H670 V320",
  "M490 120 H510 V140 H560",
  "M430 90 H490 V100",
  "M370 230 H390 V240 H470 V190 H420 V140",
  "M570 320 H540 V330",
  "M490 200 V190 H510 V260 H440 V310",
  "M620 40 V20 H690 V0",
  "M660 140 H680 V130 H700",
  "M400 350 V390",
  "M790 70 V130 H770 V140",
  "M80 110 H0",
  "M540 230 H580 V250 H600",
  "M750 0 V10 H730 V0 H710 V20",
  "M310 150 V90 H330 V30 H380 V0",
  "M200 350 H180 V410",
  "M70 180 H0",
  "M210 250 H160 V320 H220 V330",
  "M80 210 H70 V200 H10",
  "M180 90 H220 V40",
  "M610 30 H600 V10 H570 V0",
  "M30 130 H90 V160 H110",
  "M740 300 V330 H790",
  "M390 80 H370 V50",
  "M350 80 V140 H370 V160 H380",
  "M330 370 H360 V320",
  "M310 370 V320",
  "M120 110 V120 H110 V140",
  "M30 410 H0 V360 H70 V390 H30 V380",
  "M90 70 H140",
  "M380 340 V390",
  "M410 250 V280 H420",
  "M630 140 H600 V190 H710 V200",
  "M480 120 V180",
  "M770 320 V300 H760 V210 H720",
  "M490 290 H470 V310",
  "M290 160 V180 H230 V200 H190 V210 H170 V150",
  "M50 150 H0",
  "M80 390 V410 H160",
  "M30 30 V90",
  "M550 20 H530 V0",
  "M310 170 V180 H350 V190",
  "M620 230 V210 H590 V220",
  "M790 380 H770 V350 H750",
  "M330 150 V110",
  "M610 310 H580 V270 H600 V290",
  "M210 270 H190 V280 H180",
  "M90 320 H110 V260",
  "M120 190 H80",
  "M680 390 V400 H740 V410",
  "M240 230 H150 V220",
  "M520 120 H590",
  "M240 330 V320 H270",
  "M610 100 V60 H620",
  "M770 70 V40 H790",
  "M460 0 H400 V60 H390",
  "M260 60 V70 H280 V50 H270 V20",
  "M270 340 V390",
];
...
const PCB_ACTIVE_TRACES = new Set([0,2,4,8,11,12,15,17,19,21,23,26,28,35,36,39,42,46,50,54,56,58,67,78]);

// Via dots at every turn point across all 80 traces, in percentage
// coordinates (matching the 800×420 viewBox).
const PCB_VIAS: [number, number][] = [
  [31.25, 61.9], [31.25, 47.62], [66.25, 97.62], [38.75, 71.43], [38.75, 57.14],
  [33.75, 57.14], [33.75, 64.29], [36.25, 64.29], [90, 26.19], [90, 42.86],
  [93.75, 42.86], [93.75, 38.1], [77.5, 78.57], [30, 0], [2.5, 54.76],
  [2.5, 73.81], [92.5, 61.9], [86.25, 61.9], [86.25, 66.67], [81.25, 66.67],
  [81.25, 71.43], [86.25, 71.43], [86.25, 76.19], [87.5, 76.19], [87.5, 83.33],
  [10, 9.52], [33.75, 33.33], [33.75, 21.43], [6.25, 61.9], [8.75, 61.9],
  [8.75, 80.95], [60, 92.86], [60, 80.95], [66.25, 80.95], [66.25, 90.48],
  [70, 11.9], [57.5, 11.9], [53.75, 80.95], [53.75, 78.57], [86.25, 16.67],
  [86.25, 14.29], [92.5, 14.29], [92.5, 9.52], [62.5, 2.38], [23.75, 14.29],
  [20, 14.29], [20, 30.95], [16.25, 30.95], [16.25, 47.62], [15, 47.62],
  [15, 52.38], [12.5, 2.38], [12.5, 0], [71.25, 23.81], [71.25, 21.43],
  [70, 21.43], [70, 19.05], [62.5, 19.05], [80, 50], [38.75, 9.52],
  [38.75, 2.38], [43.75, 2.38], [80, 83.33], [80, 92.86], [83.75, 92.86],
  [63.75, 28.57], [63.75, 33.33], [61.25, 21.43], [48.75, 54.76], [48.75, 57.14],
  [58.75, 57.14], [58.75, 45.24], [52.5, 45.24], [67.5, 76.19], [61.25, 45.24],
  [63.75, 45.24], [63.75, 61.9], [55, 61.9], [77.5, 4.76], [86.25, 4.76],
  [85, 33.33], [85, 30.95], [98.75, 30.95], [96.25, 30.95], [72.5, 54.76],
  [72.5, 59.52], [93.75, 2.38], [91.25, 2.38], [91.25, 0], [88.75, 0],
  [38.75, 21.43], [41.25, 21.43], [41.25, 7.14], [47.5, 7.14], [22.5, 83.33],
  [20, 59.52], [20, 76.19], [27.5, 76.19], [8.75, 50], [8.75, 47.62],
  [27.5, 21.43], [75, 7.14], [75, 2.38], [71.25, 2.38], [11.25, 30.95],
  [11.25, 38.1], [92.5, 78.57], [46.25, 19.05], [43.75, 33.33], [46.25, 33.33],
  [46.25, 38.1], [45, 88.1], [15, 28.57], [13.75, 28.57], [0, 97.62],
  [0, 85.71], [8.75, 85.71], [8.75, 92.86], [3.75, 92.86], [51.25, 66.67],
  [75, 33.33], [75, 45.24], [88.75, 45.24], [96.25, 71.43], [95, 71.43],
  [95, 50], [58.75, 69.05], [36.25, 42.86], [28.75, 42.86], [28.75, 47.62],
  [23.75, 47.62], [23.75, 50], [21.25, 50], [10, 97.62], [66.25, 4.76],
  [38.75, 42.86], [43.75, 42.86], [77.5, 50], [73.75, 50], [96.25, 90.48],
  [96.25, 83.33], [72.5, 73.81], [72.5, 64.29], [75, 64.29], [23.75, 64.29],
  [23.75, 66.67], [13.75, 76.19], [85, 95.24], [92.5, 95.24], [18.75, 54.76],
  [30, 76.19], [76.25, 14.29], [96.25, 9.52], [50, 0], [50, 14.29],
  [32.5, 16.67], [35, 16.67], [35, 11.9], [33.75, 11.9],
];
        ...
        <div data-reveal className="mt-10" style={{ perspective: "1400px" }}>
          ...
          >
            ...
            >
              ...
              {/* Three IC footprints sitting among the routed traces. */}
              ...
              <rect x="600" y="250" width="70" height="36" fill="none" stroke="#5c4a18" strokeWidth="1.3" opacity={0.5} />
              <path
                d="M617 250 V240 M635 250 V240 M653 250 V240"
                stroke="#5c4a18"
                strokeWidth="1.1"
                opacity={0.5}
              />
              <path
                d="M617 286 V296 M635 286 V296 M653 286 V296"
                stroke="#5c4a18"
                strokeWidth="1.1"
                opacity={0.5}
              />

              <rect x="110" y="330" width="70" height="36" fill="none" stroke="#5c4a18" strokeWidth="1.3" opacity={0.5} />
              <path
                d="M127 330 V320 M145 330 V320 M163 330 V320"
                stroke="#5c4a18"
                strokeWidth="1.1"
                opacity={0.5}
              />
              <path
                d="M127 366 V376 M145 366 V376 M163 366 V376"
                stroke="#5c4a18"
                strokeWidth="1.1"
                opacity={0.5}
              />
            ...
            {/* Vias: real circular elements, not SVG circles inside a
                ...
                across all 80 generated traces — sized down a touch from
                the first pass since there are ~5x as many now. */}
            {PCB_VIAS.map(([x, y], i) => (
              <span
                key={i}
                className="absolute h-[4px] w-[4px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#c9a227]"
                style={{ left: `${x}%`, top: `${y}%`, opacity: 0.65 }}
                aria-hidden="true"
              />
            ))}
